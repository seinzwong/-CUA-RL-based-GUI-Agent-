# PRM LoRA training for Feishu CUA trajectories.
...
TRAINING_OUTPUT_DIR = os.getenv("PRM_OUTPUT_DIR", "./records/progress_model_feishu_lora")
MODEL_SAVE_PATH = os.getenv("PRM_SAVE_PATH", "ckpt/qwen3_8b_feishu_prm")
...
model.backbone.save_pretrained(base_model_save_path)
